...
class DataIngestion:
    ...
    def export_data_into_feature_store(self) -> DataFrame:
        ...
        try:
            ...
            dataframe.to_csv(feature_store_file_path,index=None,header=True)
    ...
    def split_data_as_train_test(self,dataframe: DataFrame) -> None:
        ...
        Description: This method splits the dataset into train and test set base on the split size
        ...
        try:
            ...
            logging.info("Exited split_daa_as_train_test method of data ingestion class")
    ...
    def initiate_data_ingestion(self) -> DataIngestionArtifact:
        ...
        Output: train and test sets are returned as artifact of data ingestion component
        On Failure: Write an exception log and then raise an exception
